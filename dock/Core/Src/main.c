...
/* USER CODE BEGIN PV */
char receive1[500];
char *RecBuff1   = receive1;

char receive2[1000];
char *RecBuff2  = receive2;
...
//	  at_command("AT+TEST=?");
//	  at_command("AT+RTC=\"2024-06-05 17:01:00\"\r\n");
//	  at_command("AT+DR=SCHEME\r\n");
//	  at_command("AT+DR=band\r\n");
//	  HAL_Delay(1000);
//	  at_command("AT+TEMP\r\n");
//	  HAL_Delay(1000);
//  	  at_command("AT+MODE=TEST\r\n");
//  	  at_command("AT+TEST=?\r\n");
//  	  at_command("AT+TEST=RFCFG,433,SF12,125,12,15,14,ON,OFF,OFF\r\n");
//  	  AT+TEST=RFCFG,868000000,7,125,8,8,14,1,0,0\r\n
//  	  at_command("AT+TEST=TXLRSTR, \"TEST\"\r\n");
//  	AT+TEST=RFCFG,868000000,7,125,8,8,14,1,0,0\r\n
//  at_command("AT+PMSG=\"Data to send\"\r\n");
//  at_command("AT+REG\r\n");
...
//    at_command("AT+LW=CT, ON\r\n");
  	  at_command("AT+MODE=TEST\r\n");
  	  at_command("AT+TEST=?\r\n");
//  	  at_command("AT+PMSG=\"This is a string\"\r\n");
//    at_command("AT+TEST=RFCFG,433,SF12,125,12,15,14,ON,OFF,OFF\r\n");
//    at_command("AT+TEST=TXLRSTR, \"TEST\"\r\n");
